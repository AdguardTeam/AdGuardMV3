...
export const Icons = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="hidden">
            <svg id={IconId.START} width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    clipRule="evenodd"
            ...
            <svg id={IconId.LOGO} width="108" height="24">
            ...
            <svg id={IconId.EXPERIMENT} width="90" height="94" xmlns="http://www.w3.org/2000/svg">
                <defs>
            ...
            <svg id={IconId.NEW_TECH} width="100" height="104" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="a">
                        <stop stopColor="#2B2B2B" offset="0%" />
                        <stop stopColor="#131313" offset="100%" />
            ...
            <svg id={IconId.FAST_WORK} width="104" height="104" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="a">
                        <stop stopColor="#2B2B2B" offset="0%" />
                        <stop stopColor="#131313" offset="100%" />
            ...
            <svg id={IconId.CHROME_LOGO} width="94" height="94" xmlns="http://www.w3.org/2000/svg">
                <defs>
            ...
            <svg id={IconId.CRUMBS} width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
            ...
            <svg id={IconId.DISABLED_LOGO} width="68" height="68" xmlns="http://www.w3.org/2000/svg">
                <g style={{ mixBlendMode: 'luminosity' }}>
                    <path fillRule="evenodd" clipRule="evenodd" d="M33.9992 0C23.3721 0 10.5532 2.43818 1.04265e-05 7.80479C1.04265e-05 19.3952 -0.145658 48.2705 33.9992 68C68.1449 48.2705 68 19.3952 68 7.80479C57.4461 2.43818 44.6271 0 33.9992 0Z" fill="#979797" />
                    <path fillRule="evenodd" clipRule="evenodd" d="M34 4.06362e-09C33.9997 4.06362e-09 33.9995 0 33.9992 0C23.3721 0 10.5532 2.43818 1.19879e-05 7.80479C1.19879e-05 7.85351 9.41351e-06 7.90254 5.24132e-06 7.95188C-0.000606755 19.6378 -0.00211449 48.3534 33.9992 68C33.9995 67.9999 33.9997 67.9997 34 67.9996V4.06362e-09Z" fill="#888888" />
                    <path fillRule="evenodd" clipRule="evenodd" d="M33.7001 43.7143L53.4287 17.5741C51.983 16.4349 50.7149 17.2389 50.0169 17.8614L49.9914 17.8634L33.5418 34.6861L27.344 27.3537C24.3873 23.9954 20.3676 26.557 19.4286 27.234L33.7001 43.7143Z" fill="white" />
                </g>
            </svg>

            <svg id={IconId.ARROW_NAV} width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="Path 2" d="M11.6666 5L5 12L19 12" stroke="#888888" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path id="Path 2_2" d="M11.6666 19L5 12" stroke="#888888" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>

            <svg id={IconId.PLUS} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 12H20" stroke="#67B279" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M12 4L12 20" stroke="#67B279" strokeWidth="1.5" strokeLinecap="round" />
            </svg>

            <svg id={IconId.CROSS} width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.42857 6.42857L17.6043 17.6043" stroke="#A4A4A4" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M6.42859 17.5713L17.6044 6.39551" stroke="#A4A4A4" strokeWidth="1.5" strokeLinecap="round" />
            </svg>

            <svg id={IconId.CHEVRON_DOWN} width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <svg id={IconId.LINK} width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7.18079 11.3698L4.89168 13.6589C4.89168 13.6589 3.36115 15.1748 5.1962 17.0098C7.03126 18.8449 6.51922 18.3328 6.51922 18.3328C6.51922 18.3328 8.33041 20.1196 9.8414 18.6086C11.3524 17.0976 13.0895 15.3606 13.0895 15.3606C13.0895 15.3606 14.6798 13.7655 12.5524 11.6381C12.5351 11.6208 12.2073 11.293 12.2073 11.293" stroke="#67B279" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M15.8192 12.6302L18.1083 10.3411C18.1083 10.3411 19.6389 8.82524 17.8038 6.99018C15.9687 5.15512 16.4808 5.66716 16.4808 5.66716C16.4808 5.66716 14.6696 3.88038 13.1586 5.39137C11.6476 6.90236 9.91055 8.63942 9.91055 8.63942C9.91055 8.63942 8.32019 10.2345 10.4476 12.3619C10.4649 12.3792 10.7927 12.707 10.7927 12.707" stroke="#67B279" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>

            <svg id={IconId.EYE} width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="Icons/Main/EyeOpened">
                    <path id="Path 13" fillRule="evenodd" clipRule="evenodd" d="M4 11.772C6.66667 8.59065 9.33333 7 12 7C14.6667 7 17.3333 8.59065 20 11.772C20 11.772 16 16.772 12 16.772C8 16.772 4 11.772 4 11.772Z" stroke="#67B279" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    <path id="Path" fillRule="evenodd" clipRule="evenodd" d="M12 10C13.1046 10 14 10.8954 14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12C10 10.8954 10.8954 10 12 10Z" stroke="#67B279" strokeWidth="1.5" />
                </g>
            </svg>

            <svg id={IconId.CROSSED_ELEMENT} width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M3 8C3 7.44772 3.44772 7 4 7H20C20.5523 7 21 7.44772 21 8V16C21 16.5523 20.5523 17 20 17H4C3.44772 17 3 16.5523 3 16V8Z" stroke="#67B279" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M4 21L20 3" stroke="#67B279" strokeWidth="1.5" strokeLinecap="round" />
            </svg>

            <svg id={IconId.LIGHTNING} width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M8.64196 2L14.3997 2L12.4396 9.92326H17L10.5974 22L11.731 13.0147H7L8.64196 2Z" stroke="#67B279" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            ...
            <svg id={IconId.MAGNIFIER} width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="9.5" cy="9.5" r="5.5" stroke="#67B279" strokeWidth="1.5" />
                <path d="M14 14L19 19" stroke="#67B279" strokeWidth="1.5" strokeLinecap="round" />
            </svg>

            <svg id={IconId.WARNING} width="24" height="23" fill="none" xmlns="http://www.w3.org/2000/svg">
